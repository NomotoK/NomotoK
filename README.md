...
在苏联，程序永远不会报错。你问为什么循环不退出？同志，那是因为它在等待上级批准。变量的值永远不会改变，是因为变了就是叛徒。至于bug？不存在的，我们把它叫做“计划经济式执行偏差”。所以，写代码就如同五年计划——改了又改，最后实现的功能却不是你想要的，而是党需要的。
</p>
...
<p align="left">
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=NomotoK&show_icons=true&hide_title=true&hide_border=true&layout=compact&theme=transparent" style="vertical-align:top; margin:1px">
<img src="https://github-readme-stats.vercel.app/api?username=NomotoK&show_icons=true&hide_title=true&hide_border=true&theme=transparent" style="vertical-align:top; margin:1px">
</p>
